...
function shouldHandle(Ajv, req) {
    ...
    if (isMultipart(req) && ((_a = reqContentType) === null || _a === void 0 ? void 0 : _a.includes('multipart/form-data'))) {
        return true;
    }
    const bodyRef = (_d = (_c = (_b = req) === null || _b === void 0 ? void 0 : _b.openapi) === null || _c === void 0 ? void 0 : _c.schema) === null || _d === void 0 ? void 0 : _d.$ref;
    const requestBody = bodyRef
        ? Ajv.getSchema(bodyRef)
        : (_g = (_f = (_e = req) === null || _e === void 0 ? void 0 : _e.openapi) === null || _f === void 0 ? void 0 : _f.schema) === null || _g === void 0 ? void 0 : _g.requestBody;
    const bodyContent = (_h = requestBody) === null || _h === void 0 ? void 0 : _h.content;
    if (!bodyContent)
        return false;
    ...
    for (const [contentType, mediaType] of contentTypes) {
        if (!contentType.includes(reqContentType))
            continue;
        const mediaTypeSchema = (_j = mediaType) === null || _j === void 0 ? void 0 : _j.schema;
        const schema = ((_k = mediaTypeSchema) === null || _k === void 0 ? void 0 : _k.$ref) ? Ajv.getSchema(mediaTypeSchema.$ref)
            : mediaTypeSchema;
        const format = (_l = schema) === null || _l === void 0 ? void 0 : _l.format;
        if (format === 'binary') {
            return true;
        }
    }
