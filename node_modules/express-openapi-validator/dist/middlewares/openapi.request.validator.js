...
class RequestValidator {
    ...
    buildMiddleware(path, reqSchema, contentType) {
        ...
        const isBodyBinary = ((_a = body) === null || _a === void 0 ? void 0 : _a['format']) === 'binary';
    ...
    processQueryParam(query, schema, whiteList = []) {
        ...
        for (const q of queryParams) {
            ...
            else if (!((_a = allowedEmpty) === null || _a === void 0 ? void 0 : _a.has(q)) && (query[q] === '' || null)) {
    ...
    static getSecurityQueryParams(usedSecuritySchema, securitySchema) {
        return usedSecuritySchema && securitySchema
            ? usedSecuritySchema
                ...
                .filter(sec => { var _a, _b; return ((_a = sec) === null || _a === void 0 ? void 0 : _a.type) === 'apiKey' && ((_b = sec) === null || _b === void 0 ? void 0 : _b.in) == 'query'; })
                .map((sec) => sec.name)
            : [];
    }
}
